...
public class ChannelActivity extends BaseActivity implements OnItemClickListener {
    ...
    @Background
    void initData() {
        userChannelList = ((ArrayList<ChannelItem>) ChannelManager.getManager(
                App.getApp().getSQLHelper()).getUserChannel());
        otherChannelList = ((ArrayList<ChannelItem>) ChannelManager.getManager(
                        ...
                        new Handler().postDelayed(new Runnable() {
                            ...
                            public void run() {
                                try {
                                    ...
                                    ChannelManager.getManager(App.getApp().getSQLHelper()).updateChannel(channel, "0");
                    ...
                    new Handler().postDelayed(new Runnable() {
                        ...
                        public void run() {
                            try {
                                ...
                                ChannelManager.getManager(App.getApp().getSQLHelper())
                                        .updateChannel(
                                        channel, "1");
                            } catch (Exception localException) {
                            }
     ...
     */
    void saveChannel() {
        ChannelManager.getManager(App.getApp().getSQLHelper()).deleteAllChannel();
        ChannelManager.getManager(App.getApp().getSQLHelper()).saveUserChannel(
                userAdapter.getChannnelLst());
        ChannelManager.getManager(App.getApp().getSQLHelper()).saveOtherChannel(
