...
public class TuPianActivity extends BaseActivity {
    ...
    public void init() {
        ...
        fragments.add(new TuPianReDianFragment_());//精选
        fragments.add(new TuPianDuJiaFragment_());//趣图
        fragments.add(new TuPianMingXingFragment_());//明星
        fragments.add(new TuPianTiTanFragment_());//故事
        fragments.add(new TuPianMeiTuFragment_());//美图
    }
